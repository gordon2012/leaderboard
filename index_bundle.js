...
/***/ function(module, exports, __webpack_require__) {
	...
	var CamperTable = __webpack_require__(86);
	  ...
	  render: function () {
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        React.createElement("img", { src: this.props.camper.img, style: { width: "32px" } }),
	        React.createElement(
	          "span",
	          { style: { padding: "0 16px" } },
	          React.createElement(
	            "a",
	            { target: "_blank", href: 'http://www.freecodecamp.com/' + this.props.camper.username },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(31);
	var CamperRow = __webpack_require__(85);
	var $ = __webpack_require__(88);
	
	var CamperTable = React.createClass({
	  displayName: 'CamperTable',
	  ...
	  render: function () {
	    ...
	    for (var i = 0; i < campers.length; i++) {
	      rows.push(React.createElement(CamperRow, { camper: campers[i], key: i, num: i + 1 }));
	    }
	    return React.createElement(
	      'table',
	      ...
	      React.createElement(
	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            ...
	            React.createElement(
	              'button',
	              { onClick: this.handleRecent, className: this.state.sortRecent ? "btn btn-primary" : "btn btn-default" },
	              'Past 30 days'
	            )
	          ),
	          React.createElement(
	            ...
	            React.createElement(
	              'button',
	              { onClick: this.handleAlltime, className: !this.state.sortRecent ? "btn btn-primary" : "btn btn-default" },
	              'All time'
	            )
	          )
	        )
