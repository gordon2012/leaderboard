  ...
  render: function() {
    return (
      <tr>
        ...
        <td><img src={this.props.camper.img} style={{width: "32px"}}/><span style={{padding: "0 16px"}}><a target="_blank" href={'http://www.freecodecamp.com/' + this.props.camper.username}>{this.props.camper.username}</a></span></td>
